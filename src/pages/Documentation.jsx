    ...
    <header className="header bg-[#2E90FA] md:bg-[#D7DBDF] text-white md:text-[#101828] shadow py-4 px-4">
      <div className="flex flex-row items-center justify-center md:h-40 header-content">
        <h1 className="text-sm text-center md:text-3xl">
          ...
          <span className="md:text-[#2E90FA]">AI</span>
        </h1>
      </div>
    </header>
        ...
        <div className="flex flex-col flex-grow p-2 md:p-4 main-content">
          <div className="flex flex-col flex-grow mt-4 rounded">
            <section className="mb-11" id="intro">
              <h1 className="mb-4 text-base font-bold md:text-2xl ">
                Introduction
              </h1>

              <p className="mb-5 text-xs text-[#667085] md:text-lg">
                Reconcile.<span className="text-[#2E90FA]">AI</span> is a web
                application that compares third-party and independent financial
                statements and records with internal financial records and
                ledgers. It does this accurately with artificial intelligence
                from Open AI and machine learning models like GPT-3 paving the
                way for even smoother future matchings and collaboration of
                accounts from vendors. Reconcile.
                <span className="text-[#2E90FA]">AI</span> makes the day-to-day
                balancing of accounts and sales easier, faster, and very
                reliable for Small and Medium Enterprises.
              </p>
              ...
              <p className="mb-5 text-xs text-[#667085] md:text-lg">
                <span className="font-bold">Freelancers: </span> Accurate
                billing and lots of payment options get you paid faster and let
                clients pay how they like. Recurring invoices, Automated Payment
              ...
              <p className="mb-5 text-xs text-[#667085] md:text-lg">
                ...
                organized and easy to track Small
              </p>
              <p className="mb-5 text-xs text-[#667085] md:text-lg">
              ...
              <p className="mb-5 text-xs text-[#667085] md:text-lg">
                <span className="font-bold"> Accountants:</span>
            ...
            <section className="mb-11" id="howToUse">
              <h1 className="mb-4 text-base font-bold md:text-2xl">
                {" "}
                How to use Reconcile.<span className="text-[#2E90FA]">AI</span>
              </h1>

              <p className="mb-6 text-xs text-[#667085] md:text-lg">
                Welcome, aboard! We’re glad that you’ve chosen Reconcile.
                <span className="text-[#2E90FA]">AI</span> for your account
                statement matching. Let’s get you started right away on how to
                take advantage of our platform to make things easy.
              </p>
              <h2 className="text-[#194185] mb-2 text-base text-center md:text-start font-bold md:text-xl">
                Step One
              </h2>
              ...
              <picture>
                ...
                <img
                  className=" mx-[33%] mb-5 md:hidden"
                  src={steponeMobile}
                  alt=" "
                />
              </picture>
              ...
              <picture>
                <img
                  className="hidden mb-5 md:inline"
                  src={stepThree}
                  alt=" "
                />
                <img
              ...
              <h2 className="text-[#194185] text-center md:text-start mb-2 text-base font-bold md:text-xl">
                Step Four
              </h2>
              <p className="mb-5 text-xs text-[#101828] text-center md:text-start md:text-lg">
                After the reconcile.<span className="text-[#2E90FA]">AI</span>{" "}
                process is complete, click Download Button to Download your
                report in PDF or Spreadsheet format.
              </p>
            </section>
            <section id="keyFeatures">
              ...
              <h2 className="mb-5 text-xs text-[#667085] font-bold md:text-lg">
                Key Values Reconcile.<span className="text-[#2E90FA]">AI</span>{" "}
                offers.
              </h2>
              ...
              <ul className="ml-4 text-xs text-[#667085] list-disc md:text-lg">
                <li>
                  ...
                  Reconcile.<span className="text-[#2E90FA]">AI</span> uses an
                  Artificial Intelligence bot to request detailed account
                  statements from your bank at the close of business and
                  automatically performs a 3-way match of the documents from the
                  different departments.
                </li>
                <li>
                  <span className="font-bold">Easy Data Entry: </span>
                  Reconcile.<span className="text-[#2E90FA]">AI</span> offers an
                  easy and automatic invoice data entry for the suppliers and
                  the client. Creating a close touchless invoice process.
                </li>
                <li>
                  <span className="font-bold">
                    Easy Integration into ERPs:{" "}
                  </span>
                ...
                <li>
                  ...
                  Reconcile.<span className="text-[#2E90FA]">AI</span>{" "}
                  Artificial Intelligence bot helps ensure accuracy and learn
                  vendor tendencies by mapping past transactions with new ones
