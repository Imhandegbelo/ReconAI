			...
			<div>
				...
				<div>
					<div className="mx-16 py-12 md:mx-auto md:px-10">
						<h1 className="text-center text-4xl md:text-4xl lg:text-5xl font-bold text-[#1849A9] font-normal">
							JOIN US
						</h1>
				...
				<div className="w-full px-1 sm:px-12 pt-10 bg-gray-100">
					<h1 className="text-center text-4xl bg-gray-100 pt-2 pb-7 mx-auto lg:text-5xl md:text-5xl font-normal lg:pt-12 md:pt-8 sm:pt-6 text-[#1849A9] leading-6">
						OUR TEAMS
					</h1>
				...
				<div className="py-6 pt-2">
					<h1 className="text-4xl font-normal md:text-5xl lg:text-5xl text-center text-[#1849A9] mx-auto">
						BENEFITS
					</h1>
				...
				<div className="bg-gray-100 px-4 py-4">
					<h1 className="lg:text-5xl mx-2 md:text-5xl text-4xl text-[#1849A9] text-center">
						CURRENT OPENINGS
					</h1>
